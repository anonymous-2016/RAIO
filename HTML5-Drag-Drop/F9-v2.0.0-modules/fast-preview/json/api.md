...

{
    ...
    "stockfast04": {
        ...
        ssqh:"上市前后",
        fbrq:"发布日期",// fixed UI ???
    },// UI_Array = ["bgq", "syjb", "syxs", "sykcjb", "sykcxs", "jzc", "jyjs", "qbtb", "kcqbtb", "mgeps", "mgjzc", "jycsxjllje", "mgjyhdttm", "yyzsr", "yysr", "mgyysrttm", "sqlr", "zbgj", "yygj", "wfplr", "lcsy", "xjllje", "mgxjllttm", "qyzyxjll", "gdzyxjll"]
    "stockfast05": {
        name: "机构评级",
        "sj": "横轴时间",
        "st": "上调个数",
