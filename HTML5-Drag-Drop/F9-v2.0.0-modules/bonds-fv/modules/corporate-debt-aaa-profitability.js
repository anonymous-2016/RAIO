...
// corporateDebt3AP
OTC_F9_FV.Modules.corporateDebt3AP = OTC_F9_FV.Modules.corporateDebt3AP || (
    (url = ``, tbody_uid = ``, hc_uid = ``, debug = false) => {
        ...
        .then(
            (json) => {
                ...
                try {
                    ...
                    if (Object.keys(json).length > 0) {
                        ...
                        if (Array.isArray(json)) {
                            ...
                            if (Object.keys(json[0]).length > 0 && typeof(json[0]) === "object") {
                                let tds = document.querySelectorAll(`[data-value="data-otc-CDA3P"]`),
                                    // tds1, tds2, tds3
                                    date = document.querySelector(`[data-time="data-otc-CDA3P"]`),
                                ...
                                OTC_F9_FV.Modules.corporateDebt3AP.drawHS(datas, hc_uid, false);
                            }else{
                                // no data
                                let uid = `[data-none-uid="otc-corporate-debt-aaa-profitability"]`;
                                const none_div = document.querySelector(uid);
                                // const none_div = document.querySelector(`[data-none-uid="otc-corporate-debt-aaa-profitability"]`);
                                none_div.dataset.none = "no-data-div-visible";
                                // table
                                // const table = document.querySelector(`.otc-corporate-debt-aaa-profitability-table`);
                                // table.dataset.none = "no-data-div-hidden";
                                // const tbody = document.querySelector(`.otc-corporate-debt-aaa-profitability-table-tbody`);
                                const tbody = document.querySelector(tbody_uid);
                                tbody.dataset.none = "no-data-div-hidden";
                            }
                        }else{
                            let message = `handle json error!`,
                                fileName = `corporate-debt-aaa-profitability.js`,
                                lineNumber = 29;
                    ...
                    let url =`file:///E:/**/bonds-fv/modules/corporate-debt-aaa-profitability.js`;
        ...
        /*
        setTimeout((debug = false) => {
            let turn_to_uids = document.querySelectorAll(`[data-turn-to-uid="node-uid-corporate-debt-aaa-profitability-data"]`);
            if (debug) {
...
OTC_F9_FV.Modules.corporateDebt3AP.drawHS = OTC_F9_FV.Modules.corporateDebt3AP.drawHS || (
    (
        datas = {},
        container_uid = ``,
        debug = false
...
OTC_F9_FV.Modules.corporateDebt3AP.init = OTC_F9_FV.Modules.corporateDebt3AP.init || (
    (
        {
            ip,
            path,
