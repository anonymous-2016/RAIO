                        ...
                        if (Array.isArray(json)) {
                            ...
                            if (Object.keys(json[0]).length > 0 && typeof(json[0]) === "object") {
                                ...
                                setTimeout((debug = false) => {
                                    let export_excel_a = document.querySelector(`[data-excel="otc-shibor-interbank-dismantle-borrowing-interest-rates-excel"]>a`);
...
const shiborInterbankDismantleBIR = OTC_F9_FV.Modules.shiborInterbankDismantleBIR;

export default shiborInterbankDismantleBIR;
export {shiborInterbankDismantleBIR};
