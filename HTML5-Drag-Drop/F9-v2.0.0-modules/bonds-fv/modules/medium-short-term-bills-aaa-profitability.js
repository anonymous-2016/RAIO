...
/**
 * @name medium-short-term-bills-aaa-profitability 中短期票据AAA收益率(中债)
 * @author xgqfrms
 * creadted 2018.01.23
 * @param {* String} url
...
// mediumShortTermBills3AP
OTC_F9_FV.Modules.mediumShortTermBills3AP = OTC_F9_FV.Modules.mediumShortTermBills3AP || (
    (url = ``, tbody_uid = ``, hc_uid = ``, debug = false) => {
        ...
        .then(
            (json) => {
                ...
                try {
                    ...
                    if (Object.keys(json).length > 0) {
                        ...
                        if (Array.isArray(json)) {
                            ...
                            if (Object.keys(json[0]).length > 0 && typeof(json[0]) === "object") {
                                let tds = document.querySelectorAll(`[data-value="data-otc-MSTB3AP"]`),
                                    // tds1, tds2, tds3
                                    date = document.querySelector(`[data-time="data-otc-MSTB3AP"]`),
                                ...
                                setTimeout((debug = false) => {
                                    let export_excel_a = document.querySelector(`[data-excel="otc-medium-short-term-bills-aaa-profitability-excel"]>a`);
                                ...
                                OTC_F9_FV.Modules.mediumShortTermBills3AP.drawHS(datas, hc_uid, false);
                            }else{
                                // no data
                                let uid = `[data-none-uid="otc-medium-short-term-bills-aaa-profitability"]`;
                                const none_div = document.querySelector(uid);
                                // const none_div = document.querySelector(`[data-none-uid="otc-medium-short-term-bills-aaa-profitability"]`);
                                none_div.dataset.none = "no-data-div-visible";
                                // table
                                // const table = document.querySelector(`.otc-medium-short-term-bills-aaa-profitability-table`);
                                // table.dataset.none = "no-data-div-hidden";
                                // const tbody = document.querySelector(`.otc-medium-short-term-bills-aaa-profitability-table-tbody`);
                                const tbody = document.querySelector(tbody_uid);
                                tbody.dataset.none = "no-data-div-hidden";
                            }
                        }else{
                            let message = `handle json error!`,
                                fileName = `medium-short-term-bills-aaa-profitability.js`,
                                lineNumber = 29;
                    ...
                    let url =`file:///E:/**/bonds-fv/modules/medium-short-term-bills-aaa-profitability.js`;
        ...
        /*
        setTimeout((debug = false) => {
            let turn_to_uids = document.querySelectorAll(`[data-turn-to-uid="node-uid-medium-short-term-bills-aaa-profitability-data"]`);
            if (debug) {
...
OTC_F9_FV.Modules.mediumShortTermBills3AP.drawHS = OTC_F9_FV.Modules.mediumShortTermBills3AP.drawHS || (
    (
        datas = {},
        container_uid = ``,
        debug = false
...
OTC_F9_FV.Modules.mediumShortTermBills3AP.init = OTC_F9_FV.Modules.mediumShortTermBills3AP.init || (
    (
        {
            ip,
            path,
        ...
        OTC_F9_FV.Modules.mediumShortTermBills3AP(url, tbody_uid, hc_uid, false);
    }
);
