...
// ["STOCK_IP", "STOCK_Paths", "STOCK_SecCode"]
...
// http://10.1.64.125/webservice202/fastview/stock/stockfast05/600570.SH
...
window.onload = () => {
    ...
    // STOCK_IP = `10.1.5.202`;
    // console.log(`STOCK_SecCode `, STOCK_SecCode, typeof STOCK_SecCode);
    // console.log(`STOCK_Paths `, STOCK_Paths);
                    ...
                    const loadModule = (module_uid_name=``, isTable=`false`) => {
                        ...
                        setTimeout(function() {
                            ((module_uid_name, isTable) => {
                                ...
                                // link_css.setAttribute(`href`, `../js/f9-fastview/Modules/${module_uid_name}.css`);
                                ...
                                // script_dom.setAttribute(`src`, `../js/f9-fastview/Modules/${module_uid_name}.js`);
                                // script_dom.setAttribute(`src`, `../js/f9-fastview/build/js/${module_uid_name}.min.js`);
