...
/**
 * @name dividend-matters-all 今日分红
 * @author xgqfrms
 * creadted 2017.12.21
 * @param {* String} url
 * @param {* Array} tds
...
const ShowTabs = (link_uid = `[data-tab="tab-link-DM"]`, div_uid = `[data-tab="tab-container-DM"]`, debug = false) => {
...
setTimeout(() => {
    ShowTabs();
    let scripts_container = document.querySelector(`[data-scripts="all-scripts-dividend-matters-all"]`);
    const arr = [
        // "../build/js/dividend-matters-preplan.min.js",
        // "../build/js/dividend-matters-implementation.min.js",
        "./build/js/dividend-matters-preplan.min.js",
        "./build/js/dividend-matters-implementation.min.js",
    ];
    // console.log(`arr = \n`, arr);
    ...
    setTimeout((debug = false) => {
        let turn_to_uid = document.querySelector(`[data-turn-to-uid="node-uid-dividend-matters-all"]`);
        if (debug) {
