 ...
 * updated by xgqfrms on 2017-11-07
 */
(function(root, factory) {
    ...
    // error
    // throw new Error('Highcharts is undefined!');
    // Uncaught Error: Highcharts is undefined!
    ...
    var Highextend;
    var version = '0.0.3';
    var H = win.Highcharts || error('Highcharts is not found', true);// ??? error
    ...
    Chart.prototype = {
        set: function(str, value) {
            ...
            if (arr.length == 1) {
                ...
                map.config[arr[0]][arr[1]][arr[2]][arr[3]][arr[4]] = value;
            }
        ...
        setExtendConfig: function(d, options) { //非饼图，需要坐标轴配置
            ...
            this.set('xAxis.min', options.min);
            this.set('xAxis.max', options.max);
            // yAxis
            this.set('yAxis.title.text', options.Ytitle);
            this.set('yAxis.title.text', options.Ytitle);
            // gridLineColor:'#2D3039',
            this.set('yAxis.gridLineColor', options.gridLineColor);
        ...
        setPieConfig: function(d, options) { //饼图需要的配置项
            ...
            if (options.pieClick) {
                this.set('plotOptions.pie.allowPointSelect', true);
                this.set('plotOptions.pie.cursor', 'pointer');
            }
            this.set('plotOptions.pie.dataLabels.enabled', options.showPercentLabels || false);
            this.set('plotOptions.pie.dataLabels.style.color',options.optioncolor);
            this.set('plotOptions.pie.dataLabels.distance',options.distance);
        ...
        getConfig: function(elem, d, options, type) {
            ...
            this.set('chart.options3d.enabled', options.is3Dchart);
            ...
            // this.set('scrollbar.enabled',options.scrollbar);  
            var arr = [];
